...
const NovaBotSection = () => {
  ...
  return (
    <section id="nova-bot" className="py-20 md:py-32 bg-[#21242D] relative overflow-hidden">
      {/* Background */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#3B4961]/5 rounded-full blur-3xl" />
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-7xl relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-[#3B4961]/30 px-4 py-2 rounded-full mb-6">
              <Bot className="w-4 h-4 text-[#CBCCC8]" />
              <span className="text-sm text-[#A6A39D]">{t('مساعدك الذكي', 'Your Smart Assistant')}</span>
            </div>

            <h2 className="text-3xl md:text-5xl font-semibold text-[#CBCCC8] mb-6" data-testid="bot-title">
              {t('تعرف على Nova Bot', 'Meet Nova Bot')}
            </h2>
            
            <p className="text-base md:text-lg text-[#A6A39D] leading-relaxed mb-8">
              {t(
            ...
            <div className="space-y-4 mb-8">
              {features.map((feature, index) => (
                ...
                >
                  <div className="p-2 bg-[#3B4961]/30 rounded-lg">
                    <feature.icon className="w-5 h-5 text-[#CBCCC8]" />
                  </div>
                  <div>
                    <h4 className="text-[#CBCCC8] font-medium mb-1">{feature.title}</h4>
                    <p className="text-sm text-[#A6A39D]">{feature.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
            ...
            <div className="glass-card p-8 rounded-3xl border border-[#3B4961]/30">
              ...
              <div className="space-y-4">
                <motion.div
                  ...
                  className="bg-[#3B4961]/30 p-4 rounded-2xl rounded-tl-none max-w-[80%]"
                >
                  <p className="text-[#CBCCC8] text-sm">
                ...
                <motion.div
                  ...
                  className={`bg-[#21242D] border border-[#3B4961]/30 p-4 rounded-2xl ${isRTL ? 'rounded-tr-none mr-auto' : 'rounded-tr-none ml-auto'} max-w-[80%]`}
                >
              ...
              {/* Chat Input */}
              <div className="mt-6 pt-6 border-t border-[#3B4961]/30">
                <div className="bg-[#21242D] border border-[#3B4961]/30 rounded-xl p-4 flex items-center gap-3">
